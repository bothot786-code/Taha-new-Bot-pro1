...
const API_URL = "https://priyanshuapi.qzz.io/api/runner/priyanshu-ai"; // unchanged (external service)
  ...
  run: async function({ api, message, args }) {
    ...
    if (!args.length) {
      try {
        ...
        if (senderID === "100075933317520") replyCategory = "100075933317520";
